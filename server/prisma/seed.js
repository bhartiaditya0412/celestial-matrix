...
async function seed() {
  ...
  const kyle = await prisma.user.create({ data: { name: "Kyle","email":"Kyle@gmail.com","password":"mypassword" } })
  const sally = await prisma.user.create({ data: { name: "Sally" ,"email":"sally@gmail.com","password":"mypassword1"} })
